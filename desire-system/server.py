...
# 欲求レベル読み込み元
DESIRES_PATH = Path(os.getenv("DESIRES_PATH", str(Path.home() / ".codex" / "desires.json")))
    ...
    if name == "satisfy_desire":
        try:
            ...
            chroma_path = os.getenv(
                "MEMORY_DB_PATH",
                str(Path.home() / ".codex" / "memories" / "chroma"),
            )
            collection_name = os.getenv("MEMORY_COLLECTION_NAME", "codex_memories")
