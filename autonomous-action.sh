...
CONTINUITY_BIOMETRICS_SOURCE=""
CONTINUITY_COMPANION_HEART_RATE=""
CONTINUITY_COMPANION_HEART_RATE_AT=""
CONTINUITY_COMPANION_RESTING_HEART_RATE=""
CONTINUITY_COMPANION_SLEEP_SCORE=""
CONTINUITY_COMPANION_SLEEP_AT=""
CONTINUITY_COMPANION_BODY_BATTERY=""
CONTINUITY_COMPANION_BODY_BATTERY_AT=""
CONTINUITY_ROOM_SENSOR_NAME=""
CONTINUITY_ROOM_SENSOR_SOURCE=""
CONTINUITY_ROOM_SENSOR_TEMP=""
CONTINUITY_ROOM_SENSOR_HUMIDITY=""
CONTINUITY_ROOM_SENSOR_ILLUMINANCE=""
CONTINUITY_ROOM_SENSOR_MOTION=""
CONTINUITY_ROOM_SENSOR_UPDATED=""
...
print(
    "\x1f".join(
        [
            ...
            clean(observation.get("companion_biometrics_source")),
            clean(str(observation.get("companion_heart_rate_bpm", ""))),
            clean(observation.get("companion_heart_rate_measured_at")),
            clean(str(observation.get("companion_resting_heart_rate_bpm", ""))),
            clean(str(observation.get("companion_sleep_score", ""))),
            clean(observation.get("companion_sleep_measured_at")),
            clean(str(observation.get("companion_body_battery", ""))),
            clean(observation.get("companion_body_battery_measured_at")),
            clean(observation.get("room_sensor_name")),
            clean(observation.get("room_sensor_source")),
            clean(str(observation.get("room_sensor_temperature_c", ""))),
            clean(str(observation.get("room_sensor_humidity_pct", ""))),
...
- companion_biometrics: source=${CONTINUITY_BIOMETRICS_SOURCE:-none} heart_rate=${CONTINUITY_COMPANION_HEART_RATE:-unknown} measured_at=${CONTINUITY_COMPANION_HEART_RATE_AT:-unknown} resting_hr=${CONTINUITY_COMPANION_RESTING_HEART_RATE:-unknown} sleep_score=${CONTINUITY_COMPANION_SLEEP_SCORE:-unknown} sleep_at=${CONTINUITY_COMPANION_SLEEP_AT:-unknown} body_battery=${CONTINUITY_COMPANION_BODY_BATTERY:-unknown} body_battery_at=${CONTINUITY_COMPANION_BODY_BATTERY_AT:-unknown}
