...
class WelcomePage(QWizardPage):
    ...
    def __init__(self):
        super().__init__()
        self.setTitle("Welcome to Embodied Codex")
        self.setSubTitle(
            "Give Codex physical senses: eyes, ears, and long-term memory"
        )
        ...
        description.setHtml(
            ...
            <p>
                Embodied Codex は、安価なハードウェア（約4,000円）で Codex に
        ...
        # Note
        note = QLabel(
            "⚠️ このインストーラは Codex CLI の MCP 設定を自動生成します。\n"
