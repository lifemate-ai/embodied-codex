...
class CompletePage(QWizardPage):
    ...
    def __init__(self):
        ...
        self.setSubTitle("Embodied Codex is ready to use")
        ...
        next_steps.setHtml(
            ...
            <ol>
                <li><strong>Restart Codex CLI</strong> to load the new MCP servers</li>
                ...
                <li><strong>Check the documentation:</strong>
                    <a href="https://github.com/kmizu/embodied-codex">
                    GitHub Repository
                    </a>
                </li>
            </ol>
            ...
            <p>Your Codex CLI now has access to:</p>
            <ul>
            ...
            <ul>
                <li>Check <code>~/.codex/config.toml</code> for MCP configuration</li>
                <li>View registered servers with <code>codex mcp list</code></li>
                <li>Report issues on
                    <a href="https://github.com/kmizu/embodied-codex/issues">
                    GitHub Issues
                    </a>
                </li>
            </ul>
